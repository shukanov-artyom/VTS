...
namespace VTSWeb.Localization
{
    ...
    {
        public static void AddListener(TranslationManager source,
            IWeakEventListener listener)
        {
            CurrentManager.ProtectedAddListener(source, listener);
        }

        public static void RemoveListener(TranslationManager source,
            IWeakEventListener listener)
        {
        ...
        private static LanguageChangedEventManager CurrentManager
        {
            get
            {
                ...
                var manager = (LanguageChangedEventManager)
