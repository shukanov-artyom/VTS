...
namespace VTS.AnalysisCore.Common.Psa
{
    public class LocalizedCharacteristicsStrings
    {
        ...
        private const string VehicleProductionDateItemStringRu = "Дата начала гарантии";
        private const string VehicleProductionDateItemStringEn = "Warranty Start Date";

        public static string ResolveProductionDateKey(string lang)
        {
            if (lang == "en_GB")
            {
                return VehicleProductionDateItemStringEn;
            }
            else if (lang == "ru_RU")
            {
                return VehicleProductionDateItemStringRu;
            }
            else
            {
